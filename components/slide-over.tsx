...
const gradientClasses: Record<string, string> = {
  ...
  members: "bg-gradient-to-r from-violet-600 to-purple-600",
  shares: "bg-gradient-to-r from-blue-600 via-emerald-500 to-cyan-500",
  assets: "bg-gradient-to-r from-amber-600 to-orange-600",
  orange: "bg-gradient-to-r from-orange-600 to-rose-600",
